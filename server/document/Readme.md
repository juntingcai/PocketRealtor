...
## OutLine
### User
* [Register](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/User.md#user-register)
* [Sign In](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/User.md#user-login)
* [Token Usage](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/User.md#token)
* [Update Passowrd](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/User.md#update-profile-token-needed)
* [Update User Role](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/User.md#update-users-role-token-needed)
* [Update User Avatar](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/User.md#update-users-avatar-token-needed)
* [Get User Profile](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/User.md#get-someones-profile)
* [Get User Role](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/User.md#get-users-role)


### Listing
* [Create Listing](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/Listing.md#create-a-house-listinghost-user-token-needed)
* [Copy Listing](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/Listing.md#duplicate-a-house-listingowner-token-needed)
...
* [Update Living Preference](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/Tenant.md#update-tenants-living-location-preference-tenant-token-needed)
* [Search Tenants(with filter)](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/Tenant.md#search-tenants)
* [Get A Teanat's Preference](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/Tenant.md#get-a-tenants-preference)
* [Add a listing to favorite listings](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/Tenant.md#like-a-listing-token-needed)
* [Delete a listing from the favorite listings](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/Tenant.md#deletion-from-favorite-listing-token-needed)
* [View all favorite listings](https://github.com/sfdevshop/PocketRealtorApp/blob/serverBuilding/server/document/Tenant.md#view-favorite-list-token-needed)
