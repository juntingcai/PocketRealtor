...
const TenantZipPreference = require("./tenantZipPreferences")(sequelize, DataTypes);
...
User.belongsToMany(Listing, {through: FavoriteListing, foreignKey: "user_id"})
Listing.belongsToMany(User, {through: FavoriteListing, foreignKey: "listing_id"});
